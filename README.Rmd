...
![Fig. 1](https://github.com/bbarker505/ddrp_v2/blob/master/images/model_overview.png?raw=true)
...
![Fig. 2](https://github.com/bbarker505/ddrp_v2/blob/master/images/spp_models.png?raw=true)
...
![Fig. 3](https://github.com/bbarker505/ddrp_v2/blob/master/images/EAB_2021.gif?raw=true)

Another way to look at this (mostly) same information is with a phenological event map, below (Fig. 4).

![Fig. 4](https://github.com/bbarker505/ddrp_v2/blob/master/images/EAB_Avg_PEMp0Excl2_20211231.png?raw=TRUE)

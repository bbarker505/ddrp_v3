...
al.??2023, )](https://doi.org/10.3389/finsc.2023.1239173)[Barker et al.
...
Phenology Network](https://www.usanpn.org/data/maps/forecasts).
...
requirements for development and survival of a species. Parameter files for
the 18 pest species with models (Table 1) are included in the repository.

We typically run DDRP using current and forecast climate data for the conterminous U.S.
